...
/**
 * Servlet implementation class RefrescarReunionServlet
 */
@WebServlet("/RefrescarReunionServlet")
public class RefrescarReunionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RefrescarReunionServlet() {
        super();
