	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<h2>Android</h2>
				<p>Android es un sistema operativo basado en Linux, diseÃ±ado
					principalmente para mÃ³viles con pantalla tÃ¡ctil como telÃ©fonos
					inteligentes o tabletas inicialmente desarrollados por Android,
					Inc.</p>
				<p>
					<a class="btn" href="curriculum.html">Ver m&aacute;s &raquo;</a>
				</p>
			</div>
